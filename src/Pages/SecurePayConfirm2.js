...
export default function SecurePayConfirm2() {
    ...
    <div className="SecureCheckoutConfirm">
      ...
      <div className="booked-data-cancel-info">
        ...
        <div className="booked-data-info-body">
          ...
          <span className="h-1 w-full font-bold text-red-600">
            ₹{data.totalPrice.toFixed(0) * (3 / 10)}
          </span>
          <br />₹{" "}
      ...
      <div className="flex">
        <button
          ...
          onClick={() => {
            cancelBookings(data._id)
            navigate("/securepayconfirm3", {
              state: {
                data: data,
        ...
        <span onClick={() => navigate("/")} className="my-[50px] mx-[20px]">
          Don’t Cancel this booking
        </span>
      </div>
